...
class Charactersfavlistscreenscontroller extends CharactersScreemInterface {
  final GetAllCharacters getAllCharacters = DIService.getDependency<GetAllCharacters>();
  final CharacterDatabase characterDatabase = DIService.getDependency<CharacterDatabase>();
